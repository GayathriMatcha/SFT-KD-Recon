...
#             target = target[recons_key].astype(np.float64)
          
#             recons = recons['reconstruction'].value
#             recons = recons['reconstruction'].astype(np.float64)
...
if __name__ == '__main__':
    ...
    parser.add_argument('--target_path', type=pathlib.Path, required=True,
